...
def main():
    ...
    report_output = os.environ.get("TRANSTRACK_REPORT_OUTPUT", None)
    ...
    try:
        ...
        if report_output:
            save_report_text(audit_result, report_output)
...
#
# Save report to file:
#   set TRANSTRACK_REPORT_OUTPUT=audit_report_20250101.txt
#   python audit_permissions.py
#
# =============================================================================
